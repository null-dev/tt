...
impl<T> EventLoopWindowTargetExtUnix for EventLoopWindowTarget<T> {
    ...
    fn unix_backend(&self) -> Backend {
        match self.p {
            ...
            #[cfg(feature = "fbdev")]
            LinuxEventLoopWindowTarget::FbDev(_) => Backend::FbDev,
        }
    }
    ...
    fn xlib_xconnection(&self) -> Option<Arc<XConnection>> {
        match self.p {
            ...
            #[cfg(any(feature = "wayland", feature = "kms", feature = "fbdev"))]
            _ => None,
        }
    }
    ...
    fn wayland_display(&self) -> Option<*mut raw::c_void> {
        match self.p {
            ...
            #[cfg(any(feature = "x11", feature = "kms", feature = "fbdev"))]
            _ => None,
        }
    }
    ...
    fn drm_device(&self) -> Option<&Card> {
        match self.p {
            ...
            #[cfg(any(feature = "x11", feature = "wayland", feature = "fbdev"))]
            _ => None,
        }
    }
...
pub trait EventLoopBuilderExtUnix {
    ...
    /// Force using fbdev
    #[cfg(feature = "fbdev")]
    fn with_fbdev(&mut self) -> &mut Self;
...
impl<T> EventLoopBuilderExtUnix for EventLoopBuilder<T> {
    ...
    #[cfg(feature = "fbdev")]
    fn with_fbdev(&mut self) -> &mut Self {
        self.platform_specific.forced_backend = Some(Backend::FbDev);
        self
    }
